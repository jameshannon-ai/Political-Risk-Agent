...
| --- | --- | --- | --- | --- | --- |
| REQ-HSO-A | official_maritime_security | Establishes whether transit conditions create live security, detention, crew-safety or voyage-approval risk. | official_primary, official_guidance | ukmto.org, imo.org, ics-shipping.org, bimco.org, intertanko.com, ocimf.org | Current official maritime/security guidance, preferably checked within 30 days. |
| REQ-HSO-B | transit_control_or_constabulary_actions | Captures Iranian transit-control mechanisms, vessel coordination requirements, detention risk, naval warnings or expanded control claims. | reputable_news, official_primary | reuters.com, apnews.com, ukmto.org, imo.org, gov.uk | Current operational reporting and advisories, preferably within 30 days. |
| REQ-HSO-C | sanctions_and_safe_passage_payment_risk | Identifies whether tolls, safe-passage payments, digital asset payments, offsets, swaps, guarantees or in-kind arrangements could create sanctions exposure. | official_primary, specialist_analysis, reputable_news | ofac.treasury.gov, ofsi.gov.uk, gov.uk, reuters.com, apnews.com | Current sanctions guidance or reporting, preferably within 30 days. |
| REQ-HSO-D | war_risk_insurance_pricing | Measures how insurance repricing affects voyage economics and whether insurance cost changes route decisions. | insurance_market_evidence, reputable_news | howdenre.com, lmalloyds.com, lloydslist.com, reuters.com | Current insurance-market evidence, preferably within 30 days. |
| REQ-HSO-E | vessel_flow_and_AIS_behaviour | Shows whether actual vessel behaviour confirms constrained transit, AIS suppression, trapped vessels, traffic collapse or partial reopening. | vessel_flow_or_freight_market_evidence, reputable_news, specialist_analysis | reuters.com, kpler.com, vortexa.com, lloydslist.com, marinetraffic.com, gibsons.co.uk, apnews.com | Recent vessel-flow or AIS evidence, preferably within 30 days. |
| REQ-HSO-F | energy_cargo_and_chokepoint_exposure | Quantifies why Hormuz disruption matters for oil, LNG, tanker cargoes and UK-linked energy/shipping exposure. | energy_chokepoint_data, specialist_analysis | eia.gov, iea.org, unctad.org, spglobal.com | Recent structural data or current maintained chokepoint data. |
| REQ-HSO-G | route_cost_and_arbitrage_inputs | Supports comparison of transit, delay and rerouting options through fuel cost, voyage days, insurance premium, demurrage and charter exposure. | insurance_market_evidence, specialist_analysis, reputable_news | howdenre.com, lloydslist.com, spglobal.com, reuters.com | Current market inputs plus operator assumptions validated for the voyage. |
| REQ-HSO-H | contrary_or_de_escalation_evidence | Prevents one-way escalation analysis and defines conditions under which direct transit may become acceptable again. | contrary_or_stabilising_evidence, reputable_news, official_primary | reuters.com, apnews.com, gov.uk, ukmto.org, imo.org | Current de-escalation reporting and vessel-flow evidence, preferably within 30 days. |
