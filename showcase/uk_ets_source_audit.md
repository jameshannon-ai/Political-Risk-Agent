...
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| likelihood | 5 | Severe | analyst_assumption | high | L1, L2, L4, L5, L6, L7, L8 | L8 | None | None |  |
| impact | 4 | High | analyst_assumption | high | L3, L4, L5, L6, L8 | L8 | None | None |  |
| immediacy | 5 | Severe | analyst_assumption | high | L1, L2, L3 | L8 | None | None |  |
| exposure | 4 | High | analyst_assumption | high | L1, L2, L3, L4, L5, L6, L7, L8 | L8 | None | None |  |
| confidence | 4 | High | analyst_assumption | high | L8 | L8 | None | None | Capped because Confidence capped below 5 because official policy evidence is strong, but the calculation uses illustrative voyage assumptions and a manual UKA price rather than an embedded live price feed. |
...
| --- | ---: | --- | --- | --- |
| likelihood | 5 | Official UK ETS policy sources confirm domestic maritime expansion from 1 July 2026 for covered vessels and routes. |  | Confidence capped below 5 because official policy evidence is strong, but the calculation uses illustrative voyage assumptions and a manual UKA price rather than an embedded live price feed. |
| impact | 4 | Impact is material for in-scope domestic routes because allowance cost becomes a recurring voyage-level cost, but the score is limited because UK-international routes remain scenario-only and operator-specific fuel burn must be validated. |  | Confidence capped below 5 because official policy evidence is strong, but the calculation uses illustrative voyage assumptions and a manual UKA price rather than an embedded live price feed. |
| immediacy | 5 | Immediacy is high because operators need to prepare MRV, reporting, verification, allowance procurement and pricing/pass-through processes before the scheme date. |  | Confidence capped below 5 because official policy evidence is strong, but the calculation uses illustrative voyage assumptions and a manual UKA price rather than an embedded live price feed. |
| confidence | 4 | Confidence is capped at 4/5 because official policy evidence is strong, but the calculation uses illustrative voyage assumptions and a manual UKA price rather than an embedded live price feed. |  | Confidence capped below 5 because official policy evidence is strong, but the calculation uses illustrative voyage assumptions and a manual UKA price rather than an embedded live price feed. |
...
| --- | --- | --- | --- | --- | --- |
| official_policy_scope | high | L1, L2, L4, L7 | Confirms whether the rule applies to the vessel, voyage and emissions type. | No immediate coverage gap; analyst should still verify recency and source content. | false |
| reporting_surrender_timeline | high | L1, L2, L4, L6, L7 | Confirms MRV, reporting and allowance surrender deadlines. | No immediate coverage gap; analyst should still verify recency and source content. | false |
| carbon_price_evidence | medium | L3, L6 | Provides the allowance price needed to calculate estimated carbon cost exposure. | No immediate coverage gap; analyst should still verify recency and source content. | false |
| emissions_factor_evidence | medium | L1, L2, L4, L6, L7 | Converts fuel consumption into estimated emissions. | No immediate coverage gap; analyst should still verify recency and source content. | false |
| operator_guidance | medium | L3, L5, L6 | Shows how shipping operators and maritime advisers are interpreting and implementing the rule. | No immediate coverage gap; analyst should still verify recency and source content. | false |
| legal_practical_analysis | medium | L1, L2, L4, L6, L7 | Explains obligations, exemptions, uncertainty and compliance approach. | No immediate coverage gap; analyst should still verify recency and source content. | false |
| future_scope_or_international_extension | medium | L1, L2, L4, L6, L7, L8 | Captures the risk that future policy may expand to international voyages or wider emissions categories. | No immediate coverage gap; analyst should still verify recency and source content. | false |
| contrary_or_scope_limited_evidence | medium | L1, L2, L4, L6, L7, L8 | Prevents over-application to routes, vessels or emissions outside scope. | No immediate coverage gap; analyst should still verify recency and source content. | false |
...
- Strongest evidence category: specialist_analysis
